...
typedef SWIFT_ENUM_NAMED(NSInteger, SBChatError, "ChatError", open) {
  ...
  SBChatErrorNotSupported = 800111,
...
/// Poll events
  SBDCollectionEventSourceEventPollUpdated = 131,
  SBDCollectionEventSourceEventPollVoted = 132,
  SBDCollectionEventSourceEventPollChangeLog = 133,
};
...
/// \param token Specifies the token to be the reference point for the changelogs to retrieve.
///
/// \param completionHandler The handler block to execute. The <code>updatedPolls</code> retrieves the
/// updated polls. The <code>deletedPollIds</code> retrieves the unique ID of deleted polls.
/// The <code>hasMore</code> indicates whether there are more changelogs to be retrieved. The <code>token</code>
/// retrieves the token of the last changelog in the results. The <code>error</code> indicates whether there is
/// an error. If there is no error, the value is <code>nil</code>.
///
- (void)getPollChangeLogsWithToken:(NSString * _Nullable)token completionHandler:(void (^ _Nullable)(NSArray<SBDPoll *> * _Nullable, NSArray<NSNumber *> * _Nullable, BOOL, NSString * _Nullable, SBError * _Nullable))completionHandler;
/// Retrieves the changelogs since a specified timestamp regarding the updated polls or the unique IDs
/// of deleted polls in the channel.
/// since:
/// 4.1.0
/// \param timestamp Specifies the timestamp to be the reference point for changelogs to retrieve, in Unix milliseconds format.
...
- (SBDPollListQuery * _Nullable)createPollListQueryWithLimit:(NSUInteger)limit SWIFT_WARN_UNUSED_RESULT;
...
///
/// \param limit voter list length
///
///
/// returns:
/// poll voter list query object.
- (SBDPollVoterListQuery * _Nonnull)createPollVoterListQueryWithPollId:(int64_t)pollId pollOptionId:(int64_t)pollOptionId limit:(NSUInteger)limit SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>PollVoterListQuery</code> instance for getting user list on given poll option
/// since:
/// 4.1.0
/// \param pollId poll ID.
...
/// returns:
/// poll voter list query object.
- (SBDPollVoterListQuery * _Nonnull)createPollVoterListQueryWithPollId:(int64_t)pollId pollOptionId:(int64_t)pollOptionId SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)getReadReceiptOf:(SBDBaseMessage * _Nonnull)message SWIFT_UNAVAILABLE_MSG("`getReadReceipt(of:)` has been removed.");
...
/// since:
/// 3.1.0
SWIFT_PROTOCOL("_TtP15SendbirdChatSDK28InternalChannelEventDelegate_")
@protocol InternalChannelEventDelegate
@optional
...
- (void)channel:(SBDGroupChannel * _Nonnull)channel selfVotedEvent:(SBDPollVoteEvent * _Nonnull)selfVotedEvent;
@end


@interface SBDGroupChannelCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <InternalChannelEventDelegate>
- (void)channel:(SBDBaseChannel * _Nonnull)channel new:(SBDBaseMessage * _Nullable)new_;
@end
...
/// \param channel The channel that has the message thread.
///
/// \param id just removed poll id
///
- (void)channel:(SBDGroupChannel * _Nonnull)channel pollWasDeleted:(int64_t)pollId;
@end
...
@interface SBDMessageCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <InternalChannelEventDelegate>
- (void)channel:(SBDBaseChannel * _Nonnull)channel new:(SBDBaseMessage * _Nullable)new_;
- (void)channel:(SBDBaseChannel * _Nonnull)channel failed:(SBDBaseMessage * _Nonnull)failed source:(enum SBDCollectionEventSource)source;
- (void)channel:(SBDBaseChannel * _Nonnull)channel canceled:(SBDBaseMessage * _Nonnull)canceled;
- (void)channel:(SBDBaseChannel * _Nonnull)channel pending:(SBDBaseMessage * _Nonnull)pending;
...
/// For more information, see <a href="https://sendbird.com/docs/chat/v4/ios/channel/overview-channel#2-open-channel">Open Channel</a>.
/// since:
/// 3.0.206
...
@property (nonatomic) int64_t voterCount;
/// Poll’s Options
...
/// Set to true to enable anonymous voting. Default is false
...
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull votedPollOptionIds;
...
@property (nonatomic) int64_t closeAt;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPollCreateParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15SendbirdChatSDK15PollDeleteEvent")
@interface PollDeleteEvent : NSObject
@end
...
/// since:
/// 4.1.0
SWIFT_CLASS_NAMED("PollListQueryParams")
@interface SBDPollListQueryParams : NSObject
///
@property (nonatomic) enum SBDChannelType channelType;
...
/// <ul>
///   <li>
///     <code>default</code>: limit : 10
///   </li>
/// </ul>
@property (nonatomic) NSUInteger limit;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPollListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end

@class SBDPollOptionRetrievalParams;
...
@property (nonatomic, readonly) int64_t pollId;
/// Option ID
@property (nonatomic, readonly) int64_t pollOptionId;
...
@property (nonatomic, readonly) int64_t voteCount;
...
@property (nonatomic, readonly) int64_t lastPollVoteEventAppliedAt;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
/// Gets an option with ID.
/// \param params poll option params
///
/// \param completionHandler completion block
///
+ (void)getPollOptionWithParams:(SBDPollOptionRetrievalParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(SBDPollOption * _Nullable, SBError * _Nullable))completionHandler;
@end
...
/// since:
/// 4.1.0
SWIFT_CLASS_NAMED("PollOptionRetrievalParams")
@interface SBDPollOptionRetrievalParams : NSObject
/// Poll ID
@property (nonatomic) int64_t pollId;
/// Poll option ID
@property (nonatomic) int64_t pollOptionId;
/// Type of the channel where the poll exists in
@property (nonatomic) enum SBDChannelType channelType;
/// URL of the channel containing the poll
@property (nonatomic, copy) NSString * _Nonnull channelURL;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPollOptionRetrievalParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Updated poll
@property (nonatomic, readonly, strong) UpdatedPoll * _Nonnull poll;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) int64_t closeAt;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPollUpdateParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Indicates the query is currently loading or not
@property (nonatomic) BOOL isLoading;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("Use BaseChannel's `createPollVoterListQuery:pollOptionId:`");
/// Fetches next page
/// \param completionHandler completion handler
///
- (void)loadNextPageWithCompletionHandler:(void (^ _Nonnull)(NSArray<SBDUser *> * _Nullable, SBError * _Nullable))completionHandler;
...
/// since:
/// 4.1.0
SWIFT_CLASS_NAMED("PollVoterListQueryParams")
@interface SBDPollVoterListQueryParams : NSObject
/// Poll ID
@property (nonatomic) int64_t pollId;
/// Poll option ID
@property (nonatomic) int64_t pollOptionId;
...
/// <ul>
///   <li>
///     <code>default</code>: limit : 20
///   </li>
/// </ul>
@property (nonatomic) NSUInteger limit;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPollVoterListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// returns:
/// GroupChannelListQuery instance for the current user.
+ (SBDPollVoterListQuery * _Nonnull)createPollVoterListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPollVoterListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC15SendbirdChatSDK11UpdatedPoll")
...
- (BOOL)applyPollUpdateEvent:(SBDPollUpdateEvent * _Nonnull)pollUpdateEvent;
/// Applies updated poll data to this message object.
...
- (BOOL)applyPollVoteEvent:(SBDPollVoteEvent * _Nonnull)pollVoteEvent;
/// Applies updated poll data to this message object.
/// This method is designed to be called when <code>pollChangeLog</code> event passes the vote event object
/// since:
/// 4.1.0
/// \param poll <code>Poll</code> instance
///
///
/// returns:
/// <code>true</code> if event is successfuly applied all
- (BOOL)applyPoll:(SBDPoll * _Nonnull)poll;
